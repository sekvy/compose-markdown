...
internal class BlockQuoteImpl :
    NodeImpl(),
    BlockQuote

internal class HeadingImpl(
    override val level: Int,
) : NodeImpl(),
    Heading

internal class ThematicBreakImpl :
    NodeImpl(),
    ThematicBreak

internal class ParagraphImpl :
    NodeImpl(),
    Paragraph

internal class FencedCodeBlockImpl(
    override val literal: String,
) : NodeImpl(),
    FencedCodeBlock

internal class ImageImpl(
    override val destination: String,
) : NodeImpl(),
    Image

internal class BulletListImpl(
    override val bulletMarker: Char,
) : NodeImpl(),
    BulletList

internal class OrderedListImpl(
    override val startNumber: Int,
    override val delimiter: Char,
) : NodeImpl(),
    OrderedList

internal class TextImpl(
    override val literal: String,
) : NodeImpl(),
    Text

internal class EmphasisImpl :
    NodeImpl(),
    Emphasis

internal class StrongEmphasisImpl :
    NodeImpl(),
    StrongEmphasis

internal class CodeImpl(
    override val literal: String,
) : NodeImpl(),
    Code

internal class HardLineBreakImpl :
    NodeImpl(),
    HardLineBreak
...
internal class ListItemImpl :
    NodeImpl(),
    ListItem

internal class ListItemDelimiterImpl(
    override val literal: String,
) : NodeImpl(),
    ListItemDelimiter

internal class SoftLineBreakImpl :
    NodeImpl(),
    SoftLineBreak
